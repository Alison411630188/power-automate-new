  ...
  const contactMethods = [
    {
      ...
      title: "電子郵件",
      desc: "有任何關於 Power Automate 的問題？直接發送郵件給我們。",
      action: "support@powerautomate.example.com",
      link: "mailto:support@powerautomate.example.com"
    },
    {
      icon: <MessageSquare className="w-6 h-6 text-primary" />,
      title: "Microsoft 社群",
      desc: "加入 Power Automate 官方社群，與其他使用者交流心得。",
      action: "加入社群",
      link: "https://community.powerautomate.microsoft.com"
    },
    {
          ...
          <div className="container">
            <MotionContainer direction="up">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl">
                如果您有任何問題、建議或反饋，歡迎與我們聯絡。我們致力於提供最優質的 Power Automate 教學資源。
              </p>
            </MotionContainer>
          </div>
        </div>
                  ...
                  <Card className="border-border bg-card h-full">
                    <CardHeader>
                      <CardTitle className="text-lg flex items-center gap-2 text-card-foreground">
                        <Globe className="w-5 h-5 text-primary" /> Microsoft Power Automate 官方文件
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground mb-6">
                        查看 Microsoft 官方的 Power Automate 文件、最新更新日誌與技術支援資源。
                      </p>
                      <a
                        href="https://learn.microsoft.com/zh-tw/power-automate/"
                        target="_blank"
            ...
            <MotionContainer direction="up">
              ...
              <section className="bg-primary text-primary-foreground rounded-3xl p-12 text-center">
                ...
                <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto">
                  回到首頁，開始您的 Microsoft Power Automate 學習之旅。
                </p>
                <Link href="/">
                  <HoverScale>
                    {/* 按鈕反白處理 */}
