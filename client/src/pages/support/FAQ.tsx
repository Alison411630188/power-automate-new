...
const faqData: FAQItem[] = [
  {
    ...
    items: [
      {
        q: 'Power Automate 和 Power Apps 有什麼區別？',
        a: 'Power Automate 是自動化工具，用於自動化工作流程。Power Apps 是應用程式開發工具，用於建立業務應用程式。兩者可以結合使用，但功能不同。',
      },
      {
        q: 'Power Automate 是否免費？',
        a: 'Power Automate 提供免費版本，包含基本功能。多數企業可以免費開始使用。進階功能和更高的執行限制需要付費授權。',
      },
      {
        q: '我需要程式背景才能使用 Power Automate 嗎？',
        a: '完全不需要！Power Automate 使用拖拉介面和預先建立的連接器，任何人都可以建立自動化流程。',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: '連接器是什麼？',
        a: '連接器是 Power Automate 與其他應用程式的橋樑。例如，Outlook 連接器讓您在流程中使用郵件功能。Power Automate 支援數百個連接器。',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: '如何安裝 Power Automate Desktop？',
        a: '訪問 https://powerautomate.microsoft.com/downloads/，下載 Power Automate Desktop 應用程式，然後按照安裝精靈完成安裝。',
      },
      {
        q: '桌面流程可以自動化哪些應用程式？',
  ...
  },
  {
    ...
    items: [
      {
        q: '如何在 Teams 中使用 Power Automate？',
        a: '在 Teams 頻道中，點擊「+」新增應用程式，搜尋「Power Automate」並新增。您可以在 Teams 中直接建立和管理流程。',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '如何除錯流程中的錯誤？',
        a: '在 Power Automate 中，點擊流程的執行記錄，查看每個步驟的輸入和輸出。錯誤通常會在這裡顯示詳細資訊。',
      },
      {
        q: '我如何測試我的流程？',
