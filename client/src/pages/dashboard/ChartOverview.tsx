...
const ImagePlaceholder: React.FC<{ label?: string }> = ({
  label = '此處請替換為 Power Automate 流程實際截圖',
}) => (
...
const USE_CASES: UseCaseData[] = [
  {
    ...
    steps: [
      '在 Power Automate 首頁查看「最近 24 小時」的流程執行摘要',
      '點擊任何失敗的流程查看詳細的錯誤訊息',
      '根據錯誤類型採取相應的修正措施',
    ],
  },
            ...
            <MotionContainer direction="up">
              <section className="mb-20">
                ...
                <p className="text-muted-foreground mb-8">
                  Power Automate 提供內建的分析功能，幫助您監控所有流程的健康狀況。
                </p>
                    ...
                    <CardContent className="pt-6">
                      <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col gap-2">
                          <ImagePlaceholder label="此處請替換為 Power Automate 分析儀表板實際截圖" />
                          <p className="text-xs text-muted-foreground text-center">
                            ↑ Power Automate 分析儀表板
                          </p>
                        </div>
                      </div>
                    </CardContent>
