      ...
      <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
        ...
        <div className="container py-20">
          <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      想像您每天都需要檢查郵件、複製特定資訊到 Excel、然後發送通知給團隊。這些重複性的工作會浪費寶貴的時間。Power Automate 就是為了解決這個問題而設計的——它可以自動完成這些工作流程，讓您專注於更重要的事情。
                    </p>
                    <div className="bg-primary/5 border-l-4 border-primary p-6 rounded">
                      <p className="text-foreground font-semibold">
                        Power Automate = 自動化 + 整合 + 效率 + 無代碼
                      </p>
            ...
            <section className="mb-20">
              <MotionContainer direction="up">
                <h2 className="text-3xl font-bold text-foreground mb-10 text-center">Power Automate 的核心功能</h2>
              </MotionContainer>
            ...
            <section className="mb-20">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  { title: '連接器 (Connectors)', desc: '連接 Power Automate 與其他應用程式和服務的橋樑，如 Outlook、Teams 等。' },
