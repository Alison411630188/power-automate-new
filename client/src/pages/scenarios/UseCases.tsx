    ...
    },
    {
      ...
      steps: [
        { 
          stepNumber: 1, 
          title: '設定郵件觸發', 
          desc: '1. 登入 Power Automate，選擇觸發器：「新電子郵件送達時 (V3)」。\n2. 可點擊「顯示進階參數」，在「主旨篩選」輸入「週報」或「摘要」，讓流程精準過濾信件。', 
          ...
          <div className="max-w-5xl mx-auto space-y-36">
            ...
            <MotionContainer direction="up">
              <section className="pt-10 border-t border-border">
                <h2 className="text-3xl font-bold text-foreground mb-12 text-center">為什麼選擇 Power Automate？</h2>
