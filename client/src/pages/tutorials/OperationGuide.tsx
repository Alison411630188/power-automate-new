          ...
          <div className="container">
            <MotionContainer direction="up">
              ...
              <p className="text-lg text-muted-foreground">
                本章節將完整說明 Power Automate 的兩種主要流程類型。您可以根據您的自動化需求選擇最適合的方式。
              </p>
            </MotionContainer>
          </div>
        </div>
            ...
            <section className="mb-16">
              <MotionContainer direction="up">
                ...
                <p className="text-muted-foreground mb-8">
                  Microsoft Power Automate 提供雲端流程與桌面流程，兩者各有優勢。雲端流程適合連接應用程式和服務，桌面流程適合自動化桌面應用程式。
                </p>
              </MotionContainer>
                ...
                <TabsContent value="cloud" className="space-y-8">
                  ...
                  <MotionContainer direction="up">
                    <div className="space-y-4">
                      ...
                      {[
                        { step: 1, title: '登入 Power Automate', desc: '訪問 https://flow.microsoft.com，使用您的 Microsoft 帳戶登入' },
                ...
                <TabsContent value="desktop" className="space-y-8">
                  ...
                  <MotionContainer direction="up">
                    <div className="space-y-4">
                      ...
                      {[
                        { step: 1, title: '安裝 Power Automate Desktop', desc: '下載並安裝 Power Automate Desktop 應用程式到您的電腦' },
